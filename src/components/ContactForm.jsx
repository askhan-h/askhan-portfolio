...
const ContactForm = () => {
  ...
  const sendEmail = (e) => {
    ...
    const serviceId = process.env.REACT_APP_EMAILJS_SERVICE_ID || "service_d5feb3u";
    const templateId = process.env.REACT_APP_EMAILJS_TEMPLATE_ID || "template_193bmkw";
    const publicKey = process.env.REACT_APP_EMAILJS_PUBLIC_KEY || "vrELNyh5VmAdRNua5";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            className="lg:w-1/2"
          >
            <form ref={form} onSubmit={sendEmail} className="space-y-4 sm:space-y-6 bg-white p-6 sm:p-8 rounded-lg sm:rounded-xl shadow-sm border border-gray-100">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Send me a message</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Have a question or want to work together? Fill out the form below.</p>
              
              <div className="space-y-3 sm:space-y-4">
                <div>
                  <label htmlFor="from_name" className="block mb-1 sm:mb-2 text-xs sm:text-sm font-medium text-gray-700">Name</label>
                  <input
                    type="text"
                    id="from_name"
                    name="from_name"
                ...
                <div>
                  <label htmlFor="from_email" className="block mb-1 sm:mb-2 text-xs sm:text-sm font-medium text-gray-700">Email</label>
                  <input
                    type="email"
                    id="from_email"
                    name="from_email"
                ...
                <div>
                  <label htmlFor="message" className="block mb-1 sm:mb-2 text-xs sm:text-sm font-medium text-gray-700">Message</label>
                  <textarea
                    id="message"
                    name="message"
                    rows="4"
              ...
              {status === 'error' && (
                ...
                >
                  ...
                  Failed to send message. Please try again or contact me directly via email/WhatsApp.
                </motion.div>
              )}
            </form>
          </motion.div>
          ...
          >
            <div className="bg-white p-6 sm:p-8 rounded-lg sm:rounded-xl shadow-sm border border-gray-100 h-full">
              <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-gray-800">Quick Contact Options</h3>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-5 bg-green-50 rounded-lg">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Scan to chat on WhatsApp</p>
                  </div>
                  <div className="text-center sm:text-left">
                    <div className="flex items-center justify-center sm:justify-start gap-2 text-green-600 mb-2">
                      <FaWhatsapp className="text-xl" />
                      <h4 className="text-sm sm:text-base font-medium">WhatsApp</h4>
                    </div>
                    <p className="text-xs sm:text-sm text-gray-600">Quickly start a conversation by scanning the QR code or <a href={whatsappUrl} className="text-green-600 hover:underline" target="_blank" rel="noopener noreferrer">click here</a>.</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-5 bg-blue-50 rounded-lg">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Scan to send an email</p>
                  </div>
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">Scan the QR code or <a href={emailUrl} className="text-blue-600 hover:underline">click here</a> to send me an email directly.</p>
                  </div>
                </div>
              </div>
            </div>
