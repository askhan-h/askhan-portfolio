      ...
      <div className="container mx-auto px-2 sm:px-4 lg:px-6">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed text-base sm:text-lg font-medium">
            I hold a Bachelor's degree in Software Engineering from SLIIT (affiliated with Curtin University, Australia) 
            and maintain several professional certifications in quality engineering and test automation.
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            >
              <div className="flex items-center mb-2 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-800">Academic Background</h3>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex">
                  ...
                  <div>
                    <h4 className="font-semibold text-sm sm:text-base text-gray-800">B.Sc Software Engineering</h4>
                    <p className="text-gray-600 text-xs sm:text-sm">SLIIT / Curtin University, Australia</p>
            ...
            >
              <div className="flex items-center mb-4 sm:mb-6">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-800">Professional Certifications</h3>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                {certifications.map((cert, index) => (
                  <div key={index} className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm sm:text-base text-gray-800">{cert.title}</h4>
